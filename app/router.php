...
$routes = [
    ...
    'api-companies' => realpath(__DIR__ . '/../backend/controllers/ApiCompanyController.php'),
    'api-departments' => realpath(__DIR__ . '/../backend/controllers/ApiDepartmentController.php'),
    'api-users' => realpath(__DIR__ . '/../backend/controllers/ApiUserController.php'),
